    ...
    <div class="container">
        <div class="section-title">
            ...
            <div class="col-md-12">
               ...
               <p class="pleft">Registos disponíveis: {{countNumbers()}}</p> <input id="idsearch" type="text" class="form-control" v-model="search" placeholder="Procurar por entidades ...">
                </div>
                <br>
                ...
                <table class="table table-striped table-bordered" style="width:100%">
                    ...
                    <tbody>
                        <tr v-for="(user, index) in (sortedActivity, filteredList)" :key="index">
                            <td>{{index + 1}}</td>
                            <td>
                            <router-link :to="{name: 'regisview',params: { id: user.id}}">  
                              {{user.name}} 
                            </router-link>
                            </td> 
