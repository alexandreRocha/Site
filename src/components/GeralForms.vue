    ...
    <div class="container">
      <div class="section-title">
        <h2>NOTIFICAÇÃO DE TRATAMENTO DE DADOS</h2>
          ...
          <div class="container">
                    ...
                    <div class="col-md-12"> 
                        <div class="row">
                          ...
                          <div class="col">  
                           <select
                            class="form-select"
                            v-model="concelhoMorRepSR"
                            name="concelhoMorRepSR"
                            id="concelhoMorRepSR"
                            for="concelhoMorRepSR"
                            placeholder="- Seleciona um concelho -"
                          >
                            <option :value="null">
              ...
              <div class="col-md-12" id="divloco"><br></div>
                    <div class="col"> 
                    ...
                    <div class="col-md-12"> 
                      <input type="text" class="form-control" name="entidadeProcessInfo" id="entidadeProcessInfo" placeholder=" Qual a entidade que encarregue pelo processamento dos dados">
                    </div>
                    <div class="col-md-12">  
      ...
      <div class="col" id="divg">
        <div class="container">
          <div class="row">
            <div class="col-md-12" id="divloco">
              <div class="col-md-12" id="separacao">4. Recolha de Dados</div>
            </div>
            <div class="col-md-6">
              <div class="col-md-12"><br /></div>
              <div class="col-md-12">
                ...
                <Multiselect
                  ...
                  mode="tags"
                  placeholder="- selecione os meios de recolha direta dos dados -"
                  :close-on-select="true"
                  :searchable="true"
                  :object="true"
                  :multiple="true"
          ...
          <div class="row">
            ...
            <div class="col-md-12" v-if="checkComunicTerce">
              <label for="formFile" class="form-label"
                >Se sim, indique as entidades a quem são comunicados os dados e
                motivos da comunicação. Se tiver mais do que uma entidade clique
                no botão abaixo para adicionar mais campos.
              </label>
              <div class="col-md-12">
                <button
                ...
                >
                  ...
                  <div class="col-md-3">
                    <input
                      ...
                      id="dadosComunicadas"
                      :placeholder="+(index + 1) + '- dados transferidos '"
                    />
                  </div>
                  <div class="col-md-1">
                    <button
      ...
      <div class="col" id="divg">
        <div class="container">
          <div class="row">
            <div class="col-md-12" id="divloco">
              <div class="col-md-12" id="separacao">6. Interconexões</div>
            </div>
             <div class="col-md-12" id="divloco"><br></div>
                ...
                >
                  ...
                  <div class="col-md-2">
                    <input
                      ...
                      id="paisTransferido"
                      :placeholder="+(index + 1) + 'º- País de Transferência '"
                    />
                  </div>
                  <div class="col-md-3">
                    <input
...
export default {
  ...
  data() {
    return {
      ...
      tratamentoInfo: [
        {
          value: "Central num estabelecimento único",
          label: "Central num estabelecimento único",
        },
        {
          value: "Central com vários estabelecimentos",
